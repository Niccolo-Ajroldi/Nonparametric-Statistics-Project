...
plot(as.factor(d$state), d$percentage20_Donald_Trump)
plot(as.factor(df$state), df$percentage20_Donald_Trump)

plot(as.factor(d$state), d$lat)
plot(as.factor(df$state), df$lat)

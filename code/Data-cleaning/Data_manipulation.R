...
education <- read_excel("data/Education.xls", range="A5:AU3288")
...
poverty <- read_excel("data/PovertyEstimates.xls", sheet=1, range="A5:AB3198")
...
# tolgo pure Porto Rico, perchè tanto non votano
which(poverty$state=="PR") # non c'è più PC
